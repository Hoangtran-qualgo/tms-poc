...
table sorted by created_at DESC, with status-breakdown badges and a
'+ New run' button."""
import time
...
with tempfile.TemporaryDirectory() as td:
    ...
    # + New run button rendered with the right onclick wiring.
    assert "tmsCreateRun('Alpha', 'release-1')" in html
    ...
    print("PASS 3.A.ii group view: sort, badges, case_count, + New run button")
