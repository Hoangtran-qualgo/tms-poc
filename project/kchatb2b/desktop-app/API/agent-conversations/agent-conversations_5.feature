...
Feature: Agent conversations
  ...
  Scenario: Verify the endpoint retrieves feedback for an agent-conversation message
    ...
    And I get feedback for the selected agent-conversation message
    Then the selected agent-conversation message feedback response should be successful
