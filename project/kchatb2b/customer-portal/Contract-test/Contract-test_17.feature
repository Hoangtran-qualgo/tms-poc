...
Feature: Organization contracts
  ...
  Scenario: Verify update organization success contract and cleanup - POST 201, PATCH 200, DELETE 204
    Given I am authenticated as admin
    When I create a new organization
    Then the organization create response matches the success contract
    When I update the created organization with valid info
    Then the organization update response matches the success contract
